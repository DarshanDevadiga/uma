...
const Events = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-6 flex flex-col gap-16">
      ...
      <section className="flex flex-col md:flex-row md:justify-between items-center gap-6 border-b border-white/5 pb-6">
        {/* Time filters tabs */}
              ...
              {regSuccess ? (
                ...
                <form onSubmit={handleRegSubmit} className="flex flex-col gap-4">
                  ...
                  <button 
                    type="submit" 
                    disabled={regLoading}
                    className="btn-primary w-full py-3.5 rounded-xl text-sm font-bold mt-2 shadow-lg"
                  >
